...
<style>
/* Reuse cosmic styles or keep minimal */
body { background: #020617; color: #e6edf3; }
.roadmap { display: flex; flex-direction: column; gap: 26px; max-width: 980px; margin: 40px auto; }
.gen {
  padding: 30px;
  border-radius: 15px;
...
.gen:hover { transform: translateX(12px); box-shadow: 0 0 30px rgba(56,189,248,.45); }
.arrow { text-align: center; font-size: 30px; color: #38bdf8; }
.price-tag { color: #38bdf8; font-weight: 700; font-size: 18px; }
</style>

# 📚 Table of Contents — SGH Research Generations
...
<div class="roadmap">
  ...
  <div class="gen">
    ...
    <p class="price-tag">Suggested bundle: $10 • Individual: $50 each</p>
    <ul>
  ...
  <div class="gen">
    ...
    <p class="price-tag">Suggested bundle: $5 • Individual: $100 each</p>
    <ul>
  ...
  <div class="gen">
    ...
    <p class="price-tag">Suggested bundle: $50 • Individual: $200 each</p>
    <ul>
  ...
  <div class="gen">
    ...
    <p class="price-tag">Suggested bundle: $100 • Individual: $100 each</p>
    <ul>
